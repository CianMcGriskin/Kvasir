            ...
            for license_plate in license_plates.boxes.data.tolist():
                ...
                if car_id != -1:
                    ...
                    if license_plate_text is not None:
                        ...
                        # Create a directory for each car
                        ...
                        # additional code to save a text file with the license plate number
                        license_plate_text_filename = os.path.join(car_directory, f'license_plate_{car_id}.txt')
                        with open(license_plate_text_filename, 'w') as text_file:
                            text_file.write(license_plate_text)

                        # Save the whole car image
